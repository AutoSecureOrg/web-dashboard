...
function getWebScanInsight(button, payload) {
    // Find the next row that contains the AI response box
    const aiRow = button.closest('tr').nextElementSibling;
    if (!aiRow || !aiRow.classList.contains('ai-row')) return;

    // Show the AI response row
    aiRow.style.display = 'table-row';
...
document.addEventListener('DOMContentLoaded', function() {
    // For web scan AI fix buttons - Fix the selector here
